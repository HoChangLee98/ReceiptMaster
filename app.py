...
def main():
    ...
    if img_file is not None:
        ...
        if 'llm_result' not in st.session_state:
            ...
            st.write('#### 결과값 생성 중')
            os.environ["OPENAI_API_KEY"] = "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"  # OpenAI 키 설정
